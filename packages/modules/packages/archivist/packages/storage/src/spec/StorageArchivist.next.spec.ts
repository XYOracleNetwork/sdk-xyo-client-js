...
describe('next', () => {
  it('next', async () => {
    ...
    const sortedInsertedPayloads1 = insertedPayloads1.sort((a, b) => a._sequence > b._sequence ? 1 : -1)
    const sortedInsertedPayloads2 = (insertedPayloads2 as WithStorageMeta<Payload>[]).sort((a, b) => a._sequence > b._sequence ? 1 : -1)
