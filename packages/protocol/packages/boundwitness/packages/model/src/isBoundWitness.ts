import { isPayloadOfSchemaType, notPayloadOfSchemaType, WithMeta } from '@xyo-network/payload-model'
...
export const isBoundWitnessWithMeta = isPayloadOfSchemaType<WithMeta<BoundWitness>>(BoundWitnessSchema)
