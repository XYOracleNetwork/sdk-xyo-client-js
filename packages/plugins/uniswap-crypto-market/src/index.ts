...
const plugin: XyoPayloadPlugin<'network.xyo.crypto.market.uniswap', XyoCryptoMarketUniswapPayload, XyoUniswapCryptoMarketWitnessConfig> = createXyoPayloadPlugin<
