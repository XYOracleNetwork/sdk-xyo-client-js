...
export const getBlocks = (numBoundWitnesses = 1): Array<XyoBoundWitnessWithPartialMeta & PayloadWithPartialMeta> => {
...
export const getBlocksWithPayloads = (numBoundWitnesses = 1, numPayloads = 1): Array<XyoBoundWitnessWithPartialMeta & PayloadWithPartialMeta> => {
  return new Array(numBoundWitnesses).fill(0).map(() => {
