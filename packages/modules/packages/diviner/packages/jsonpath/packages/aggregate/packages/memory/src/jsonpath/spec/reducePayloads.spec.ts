...
describe('transformPayloads', () => {
  ...
  const cases: TestData[] = [
    [
      ...
      { [asSchema('network.xyo.test.source.a', true)]: [{ destinationField: 'c', sourcePathExpression: '$.a' }] },
    ...
    [
      ...
      {
        [asSchema('network.xyo.test.source.a', true)]: [{ destinationField: 'c', sourcePathExpression: '$.a' }],
        [asSchema('network.xyo.test.source.b', true)]: [{ destinationField: 'd', sourcePathExpression: '$.b' }],
      },
      {
        c: 0, d: 1, schema: asSchema('network.xyo.test.destination', true),
      },
    ],
    [
      ...
      {
        [asSchema('network.xyo.test.source.a', true)]: [{
